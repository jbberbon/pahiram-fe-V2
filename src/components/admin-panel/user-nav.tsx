...
export function UserNav() {
  ...
  const clearZustandStore = useUserStore(
  ...
  const handleSignout = async () => {
    startTransition(async () => {
      // Await the completion of signOut
      const loginPage: string = await signOut();
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
        ...
        <DropdownMenuItem
          ...
          onClick={async () => {
            ...
            // TODO: Handle Error and Success Response for Logout
            handleSignout();
          }}
        >
